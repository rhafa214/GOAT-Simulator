...
export default function NewsFeed() {
  ...
  useEffect(() => {
    // Generate news if we don't have any for this week
    const hasNewsThisWeek = latestNews.some(n => n.week === currentWeek && n.year === state.career.year);
    // News is generated during ADVANCE_WEEK or RESOLVE_EVENT, so we don't need to generate it here in the component.
  }, [currentWeek, latestNews, state.career.year]);;
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-4">
        ...
        {latestNews.map((news) => (
          ...
          >
            ...
            <h4 className="font-black text-sm text-zinc-200 mb-2 group-hover:text-white transition-colors leading-tight">{news.headline}</h4>
